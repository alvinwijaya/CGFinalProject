...
int main() {
    ...
    //  X     Y     Z           R     G     B
    // face 0:
       3.0f, 3.0f, 1.0f,       1.0f, 0.0f, 0.0f, // vertex 0
    ...
    // fill with data
    glBufferData(GL_ARRAY_BUFFER, sizeof(GLfloat)*sizeof(vertexData), vertexData, GL_STATIC_DRAW);
    ...
    // fill with data
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(GLuint)*sizeof(indexData), indexData, GL_STATIC_DRAW);
